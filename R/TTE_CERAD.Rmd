...
tidy_logistic_model <- function(logistic_model, caption){
  ...
  tidy_model %>%
    kable(escape = FALSE, digits = 3, caption = caption) %>%
...
**NOTE ABOUT THE DATA** : coffee beverages in the dataset are not reliably separable from milk and sugar! I proxy milk by _Total Fat_ and sugar by _Total sugar_ 
...
tidy_logistic_model(exposure_logistic_propScore, caption = "P(Coffee > 480 g/day | covariates) - Odds Ratios")
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# The code here is adapted from https://zenodo.org/records/15251863/files/Causal_Analysis_Open_Data_2025-07-20.R?download=1 
...
tidy_logistic_model(crude_logistic, caption = "P(Score > cutoff | coffee) - Odds Ratios")
...
tidy_logistic_model(ipw_logistic, caption = "P(Score > cutoff | coffee) - (IPW) Odds Ratios")
```